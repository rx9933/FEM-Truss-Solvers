# December 17th, 2023
# Euler's method to solve linear truss problems. 

# Note: difference between eulers_method and linear_method is number of iterations!

import numpy as np

# Change dataname to any linear or nonlinear input file! 
dataname = "linear2DEquTriangle.txt"
iterations = 1
